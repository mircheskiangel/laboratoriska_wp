...
public class EventController {
    ...
    @PostMapping("/increaseRating/{id}")
    public String increaseRating(@PathVariable Long id, @RequestParam(required = false) String error, Model model) {
        this.eventService.changeEventRating(id, "increment");
        return "listEvents";
    }
//    @PostMapping("/decreaseRating")
    ...
    public String changeEventRating(@PathVariable Long id, @RequestParam(required = false) String increment,
                                    @RequestParam(required = false) String decrease, HttpServletRequest req) {
        if (this.eventService.findById(id).isPresent()) {
            if (increment != null) {
                this.eventService.changeEventRating(id, "increment");
            } else if (decrease != null) {
                this.eventService.changeEventRating(id, "decrease");
            }
